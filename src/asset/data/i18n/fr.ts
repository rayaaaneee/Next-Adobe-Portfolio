...
const fr: Sentences = {
    ...
    home: {
        ...
        about: {
            title: "À propos",
            texts: [
                "Bonjour ! Je m'appelle <b>Rayane</b>, <b>développeur</b> passionné avec un grand intérêt pour la <b>technologie</b> et tout ce qui touche à l'informatique. Au fil des années, j'ai consacré mon temps à la création de divers <b>projets personnels</b>, animés par ma passion pour <b>l'apprentissage</b> et <b>l'exploration de nouvelles technologies</b>.<br/>",
...
export default fr as Sentences;