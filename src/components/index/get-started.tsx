...
const GetStarted = ({
    ...
    return (
        <Link id={`getStarted-${id}`} href={'/home'} className={cn(
            ...
            "p-4 rounded-full flex items-center justify-center text-xl font-medium text-black no-underline",
            "transition-all duration-300 border-black border-2 text-nowrap tracking-wide z-1",
